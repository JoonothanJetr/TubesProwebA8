...
const Login = ({ onLoginSuccess }) => {
    ...
    return (
        <div className="min-h-screen flex">
            ...
            <div className="w-full lg:w-1/2 flex flex-col items-center justify-center py-12 px-4 sm:px-6 lg:px-8 bg-gray-50">
                <div className="absolute top-4 left-4 lg:left-[52%]">
                    <button 
                        onClick={() => navigate('/')} 
